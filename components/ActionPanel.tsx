...
export const ActionPanel: React.FC<ActionPanelProps> = ({ data }) => {
    ...
    return (
      <div className="w-full animate-[slideUpFade_0.5s_ease-out]">
        ...
        <button
          ...
          className="w-full bg-[#25D366] hover:bg-[#20bd5a] active:scale-[0.98] text-white font-semibold py-4 rounded-2xl shadow-lg shadow-green-500/20 transition-all flex items-center justify-center gap-3"
        >
  ...
  return (
    <div className="w-full flex flex-col gap-3 animate-[slideUpFade_0.5s_ease-out]">
      <p className="text-center text-sm text-gray-500 mb-1 font-medium">¿Cómo preferís la consulta?</p>
